...
type Devices struct {
	...
	UUID string `gorm:"column:uuid;type:varchar(50);size:50;" json:"uuid"`
	...
	GcmStatus null.String `gorm:"column:gcmStatus;type:varchar(200);size:200;" json:"gcm_status"`
	//[14] confirmationKey                                varchar(35)          null: true   primary: false  isArray: false  auto: false  col: varchar         len: 35      default: []
	ConfirmationKey null.String `gorm:"column:confirmationKey;type:varchar(35);size:35;" json:"confirmation_key"`
