...
type Crontab struct {
	...
	Type null.String `gorm:"column:type;enum ('news', 'mensa', 'chat', 'kino', 'roomfinder', 'ticketsale', 'alarm', 'fileDownload','dishNameDownload','averageRatingComputation', 'canteenHeadCount');" json:"type"`
